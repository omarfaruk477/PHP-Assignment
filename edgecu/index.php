              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">
                      <a style="background-color:<?php echo $slide["btn1"]["bg_color"]; ?>" href="<?php echo $slide["btn1"]["link"];?> " class="btn1">
                      <?php echo $slide["btn1"]["title"];?> 
                      </a>
                      <a style="background-color:<?php echo $slide["btn2"]["bg_color"]; ?>" href="<?php echo $slide["btn2"]["link"];?> " class="btn2">
                      <?php echo $slide["btn2"]["title"];?> 
                      </a>
                    </div>
                  </div>
                </div>
